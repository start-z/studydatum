...
public class ReOfferConfig {
    ...
    public static String newDaBanCondition = "{t-1}日的涨停;{t-1}日股价突破30日内新高;{t-1}日的连续涨停天数>0日且{t-1}日的连续涨停天数<6日;{t-1}日14点30分前涨停;{t}日9点25分的涨跌幅>2%且{t}日9点25分的涨跌幅<7%;{t}日的竞价金额大于3000万元;{t}日的收盘价>4元且{t}日的收盘价<50元;股票简称不包含st且上市板块不包含创业板且股票市场类型不包含北交所且上市板块不包含科创板;";
    public static String lowPacketCondition = "{t-1}日涨停;{t-1}日9点25分的涨跌幅<7%;{t-1}日11点前的涨停;{t-1}日连续涨停天数小于3;{t}日振幅小于13%且为阴线;{t}日竞价金额大于2000万;0.01<({t-1}日收盘价/{t}日收盘价)-1<0.07;股价小于30;不是st股、创业板股票、北交所股票、科创板股票;";
