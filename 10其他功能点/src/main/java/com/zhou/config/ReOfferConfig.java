...
public class ReOfferConfig {
    ...
    public static String newDaBanCondition = "{t-1}日的涨停;{t-1}日的连续涨停天数>0日且{t-1}日的连续涨停天数<6日;{t-1}日14点30分前涨停;{t}日9点25分的涨跌幅>2%且{t}日9点25分的涨跌幅<5%;{t}日的早盘竞价金额>3000万元;{t}日的收盘价>4元且{t}日的收盘价<50元;股票简称不包含st且上市板块不包含创业板且股票市场类型不包含北交所且上市板块不包含科创板;";
}
