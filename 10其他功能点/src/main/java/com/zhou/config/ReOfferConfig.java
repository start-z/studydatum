...
public class ReOfferConfig {
    ...
    public static String lowPacketCondition = "{t-1}日涨停;{t-1}日9点25分的涨跌幅<7%;{t-1}日11点前的涨停;{t-1}日连续涨停天数小于3;{t}日振幅小于13%且为阴线;{t}日竞价金额大于2000万;0.01<({t-1}日收盘价/{t}日收盘价)-1<0.07;不是st股、创业板股票、北交所股票、科创板股票;";
