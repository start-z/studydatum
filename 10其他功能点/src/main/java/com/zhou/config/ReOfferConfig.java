...
public class ReOfferConfig {
    public static String longBaoYinCondition = "{t-1}日涨停;{t}日振幅小于10%;{t}日成交量大于3000万;{t}日成交量为阴线;{t}日竞价金额大于3000万;{t}日收盘价<{t-1}日收盘价;（{t}日成交量/{t-1}日成交量)<2.5;{t}日换手率>15%;不是st股、创业板股票、北交所股票、科创板股票;";
