...
public class ReOfferConfig {
    ...
    public static String lowPacketCondition = "{t-1}日首板;{t-1}日9点25分的涨跌幅<7%;3%<{t}日振幅且{t}日为阴线;{t}日个股热度排名小于500;-0.02<({t-1}日收盘价/{t}日收盘价)-1<0.07;-2%<{t}日9点25分的涨跌幅<5%;股价小于30;不是st股、创业板股票、北交所股票、科创板股票;";
